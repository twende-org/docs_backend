...
# IMPORTANT FIX:
# DO NOT rely on .env file inside Docker
# Docker already injects env vars via env_file
# So we only load .env locally (safe fallback)
...
GOOGLE_CLIENT_ID = env(
    "GOOGLE_CLIENT_ID",
    default="330709384324-hrs7ac1ovucrd4rdbjad2ahor1d3hr6l.apps.googleusercontent.com",
)
